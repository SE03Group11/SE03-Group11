...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            <form name="page" action="{{ url('admin/shop/brand/'.$brand->id) }}" method="post" class="form-horizontal">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="link" value="{{ $brand->link }}" class="form-control1" id="focusedinput" placeholder="Default Input">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input id="thumbnail1" type="text" name="image" value="{{ $brand->image }}" class="form-control1" id="focusedinput" placeholder="Default Input">
