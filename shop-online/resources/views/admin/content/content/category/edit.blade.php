...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            <form name="category" action="{{ url('admin/content/category/'.$cat->id) }}" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input id="thumbnail1" type="text" name="images" value="{{ $cat->images }}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="intro" id="txtarea1" cols="50" rows="4"
                                  class="form-control1 mytinymce">{{ $cat->intro }}</textarea></div>
                </div>
