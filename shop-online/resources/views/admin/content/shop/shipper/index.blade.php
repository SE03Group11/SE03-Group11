            ...
            <table class="table table-bordered">
                ...
                @foreach($shippers as $shipper)
                    <tr>
                        ...
                        <td>{{ $shipper->email }}</td>
                        <td>
                            <a href="{{ url('admin/content/shipperegory/'.$shipper->id.'/edit') }}" class="btn btn-warning">Sửa</a>
                            <a href="{{ url('admin/content/shipperegory/'.$shipper->id.'/delete ') }}" class="btn btn-danger">Xóa</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
